...
Mutant.seqinr <- Biostrings::translate(Mutant6)
...
#After doing some research I found using GenBank that this gene is associated with sickle beta thalassaemia and sickle cell anemia. Yes this individual has this genetic diseases
